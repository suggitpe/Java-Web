...
import org.suggs.roo.pizzashop.domain.PizzaOrderDataOnDemand;
...
privileged aspect PizzaOrderIntegrationTest_Roo_IntegrationTest {
    ...
    public void PizzaOrderIntegrationTest.testCountPizzaOrders() {
        ...
        long count = org.suggs.roo.pizzashop.domain.PizzaOrder.countPizzaOrders();
    ...
    public void PizzaOrderIntegrationTest.testFindPizzaOrder() {
        org.suggs.roo.pizzashop.domain.PizzaOrder obj = dod.getRandomPizzaOrder();
        ...
        obj = org.suggs.roo.pizzashop.domain.PizzaOrder.findPizzaOrder(id);
    ...
    public void PizzaOrderIntegrationTest.testFindAllPizzaOrders() {
        ...
        java.util.List<org.suggs.roo.pizzashop.domain.PizzaOrder> result = org.suggs.roo.pizzashop.domain.PizzaOrder.findAllPizzaOrders();
    ...
    public void PizzaOrderIntegrationTest.testFindPizzaOrderEntries() {
        ...
        java.util.List<org.suggs.roo.pizzashop.domain.PizzaOrder> result = org.suggs.roo.pizzashop.domain.PizzaOrder.findPizzaOrderEntries(0, (int) count);
    ...
    public void PizzaOrderIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyPizzaOrder(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        org.suggs.roo.pizzashop.domain.PizzaOrder merged = (org.suggs.roo.pizzashop.domain.PizzaOrder) obj.merge();
        obj.flush();
    ...
    public void PizzaOrderIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'PizzaOrder' failed to initialize correctly", dod.getRandomPizzaOrder());
        org.suggs.roo.pizzashop.domain.PizzaOrder obj = dod.getNewTransientPizzaOrder(Integer.MAX_VALUE);
    ...
    public void PizzaOrderIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'PizzaOrder' with identifier '" + id + "'", org.suggs.roo.pizzashop.domain.PizzaOrder.findPizzaOrder(id));
    }
