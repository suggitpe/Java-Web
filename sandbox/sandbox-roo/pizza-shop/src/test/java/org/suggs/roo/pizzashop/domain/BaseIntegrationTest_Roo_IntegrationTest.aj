...
import org.suggs.roo.pizzashop.domain.BaseDataOnDemand;
...
privileged aspect BaseIntegrationTest_Roo_IntegrationTest {
    ...
    public void BaseIntegrationTest.testCountBases() {
        ...
        long count = org.suggs.roo.pizzashop.domain.Base.countBases();
    ...
    public void BaseIntegrationTest.testFindBase() {
        org.suggs.roo.pizzashop.domain.Base obj = dod.getRandomBase();
        ...
        obj = org.suggs.roo.pizzashop.domain.Base.findBase(id);
    ...
    public void BaseIntegrationTest.testFindAllBases() {
        ...
        java.util.List<org.suggs.roo.pizzashop.domain.Base> result = org.suggs.roo.pizzashop.domain.Base.findAllBases();
    ...
    public void BaseIntegrationTest.testFindBaseEntries() {
        ...
        java.util.List<org.suggs.roo.pizzashop.domain.Base> result = org.suggs.roo.pizzashop.domain.Base.findBaseEntries(0, (int) count);
    ...
    public void BaseIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyBase(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        org.suggs.roo.pizzashop.domain.Base merged = (org.suggs.roo.pizzashop.domain.Base) obj.merge();
        obj.flush();
    ...
    public void BaseIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Base' failed to initialize correctly", dod.getRandomBase());
        org.suggs.roo.pizzashop.domain.Base obj = dod.getNewTransientBase(Integer.MAX_VALUE);
    ...
    public void BaseIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Base' with identifier '" + id + "'", org.suggs.roo.pizzashop.domain.Base.findBase(id));
    }
