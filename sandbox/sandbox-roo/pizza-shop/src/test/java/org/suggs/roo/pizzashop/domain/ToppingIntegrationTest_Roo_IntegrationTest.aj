...
import org.suggs.roo.pizzashop.domain.ToppingDataOnDemand;
...
privileged aspect ToppingIntegrationTest_Roo_IntegrationTest {
    ...
    public void ToppingIntegrationTest.testCountToppings() {
        ...
        long count = org.suggs.roo.pizzashop.domain.Topping.countToppings();
    ...
    public void ToppingIntegrationTest.testFindTopping() {
        org.suggs.roo.pizzashop.domain.Topping obj = dod.getRandomTopping();
        ...
        obj = org.suggs.roo.pizzashop.domain.Topping.findTopping(id);
    ...
    public void ToppingIntegrationTest.testFindAllToppings() {
        ...
        java.util.List<org.suggs.roo.pizzashop.domain.Topping> result = org.suggs.roo.pizzashop.domain.Topping.findAllToppings();
    ...
    public void ToppingIntegrationTest.testFindToppingEntries() {
        ...
        java.util.List<org.suggs.roo.pizzashop.domain.Topping> result = org.suggs.roo.pizzashop.domain.Topping.findToppingEntries(0, (int) count);
    ...
    public void ToppingIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyTopping(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        org.suggs.roo.pizzashop.domain.Topping merged = (org.suggs.roo.pizzashop.domain.Topping) obj.merge();
        obj.flush();
    ...
    public void ToppingIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Topping' failed to initialize correctly", dod.getRandomTopping());
        org.suggs.roo.pizzashop.domain.Topping obj = dod.getNewTransientTopping(Integer.MAX_VALUE);
    ...
    public void ToppingIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Topping' with identifier '" + id + "'", org.suggs.roo.pizzashop.domain.Topping.findTopping(id));
    }
